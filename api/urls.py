...
urlpatterns = [
    ...
    path('hse_trainingModel/', HseTrainingAPI.as_view(), name='HSE Trainings'),
    ...
    path('hse/', HSEHomePageView.as_view(),name='HSE'),
    ...
    path('submit_forms/', HSEView.as_view(),name='SubmitForm'),
    path('child-models/', SegmentDataAPI.as_view(), name='child-model-list'),
