...
class HSE(models.Model):
    ...
    form_submitted_date = models.DateField(default=None, null=True,blank=True)
...
class GeneralHse(models.Model):
    ...
    today_day_worked_file = models.FileField(upload_to='general_hse_files/', null=True, blank=True)
    ...
    toolbox_talk_manhours_file = models.FileField(upload_to='general_hse_files/', null=True, blank=True)
    promotional_activities = models.PositiveIntegerField()
    promotional_activities_file = models.FileField(upload_to='general_hse_files/', null=True, blank=True)
...
class HSETraining(models.Model):
    ...
    attendees_amplus_file = models.FileField(upload_to='hse_training_file/', null=True)
    duration_of_trainee = models.FloatField()
    hse_training_contractor = models.PositiveIntegerField()
    attendees_contractor_file = models.FileField(upload_to='hse_training_file/', null=True)
...
class HSEObservation(models.Model):
    hse = models.ForeignKey(HSE, on_delete=models.CASCADE,null=True,blank=True)
    hse_observation_file = models.FileField(upload_to='hse_observation_files/', null=True, blank=True)
...
class ManagementVisit(models.Model):
    ...
    no_of_management_visit_file = models.FileField(upload_to='management_visits/', null=True)
    total_finding = models.PositiveIntegerField()
    total_finding_file = models.FileField(upload_to='management_visits/', null=True)
    no_of_compilance_done = models.PositiveIntegerField()
    no_of_compilance_done_file = models.FileField(upload_to='management_visits/', null=True)
...
class SubObservation(models.Model):
    ...
    open_evidence_file = models.FileField(upload_to='sub_observation_files/', null=True)
    closed_evidence_file = models.FileField(upload_to='sub_observation_files/', null=True)
...
class StopWork(models.Model):
    ...
    open_evidence = models.FileField(upload_to='stop_work_file', null=True)
    closed_evidence = models.FileField(upload_to='stop_work_file', null=True)
    remark = models.CharField(max_length=100)
...
class SubIncident(models.Model):
    ...
    attach_report = models.FileField(upload_to='sub_incident_file', null=True)
